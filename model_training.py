...
# Optional logger import (comment out if not using a custom logger)
# from logger import get_logger
# logger = get_logger(__name__)

class SentimentModel:
    def __init__(self, model_type='logistic_regression'):
        self.model_type = model_type  # Fixed typo: mode_type -> model_type
        self.model = None
        self.history = {}
    ...
    def create_model(self):
        ...
        models = {
            ...
            'logistic_regression': LogisticRegression(
                max_iter=1000,
                random_state=42,
                C=1.0  # Fixed: Lowercase 'c' to Uppercase 'C'
            ),
            ...
            'svm': LinearSVC(
                ...
                random_state=42,
                C=1.0,  # Fixed: Lowercase 'c' to Uppercase 'C'
                dual='auto' # explicit dual to silence warnings
            )
        }
    ...
    def evaluate(self, x_test, y_test):
        ...
        y_pred = self.model.predict(x_test) # Fixed: model_predict -> model.predict
